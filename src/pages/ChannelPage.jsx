...
import { removeBackdrop, closeNav } from "../utilities/sidebarSlice";
          ...
          <div className="channelDescSection">
            ...
            <div className="channelInfoContainer">
              ...
              <div className="channelDescInfo">
                ...
                <span>
                  {calculateViews(channelData?.statistics?.subscriberCount) +
                    " subscribers"}
                </span>
                <span>
                  {calculateViews(channelData?.statistics?.videoCount) +
                    " videos"}
                </span>
              </div>
